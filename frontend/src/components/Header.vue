  ...
  <nav class="row navbar navbar-expand-lg navbar-light bg-light fixed-top px-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarToggle">
      <ul class="navbar-nav mt-2 mt-lg-0">
        ...
        <li class="nav-item" v-if="user.token==null">
          <router-link class="nav-link" to="/signup"><strong>S'inscrire</strong></router-link>
        </li>
        <li class="nav-item" v-if="user.token==null">
          <router-link class="nav-link" to="/login"><strong>Se connecter</strong></router-link>
        </li>
        <li class="nav-item" v-if="user.token!==null">
...
nav {
  position: fixed;
  top: 0;
  background-image: url("../assets/fond_entete.jpg");
